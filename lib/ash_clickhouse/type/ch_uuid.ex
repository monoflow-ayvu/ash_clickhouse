defmodule AshClickhouse.Type.ChUUID do
  @constraints [
    nullable?: [
      type: :boolean,
      default: false,
      doc: "Whether the UUID can be null: Nullable(UUID)"
    ],
    low_cardinality?: [
      type: :boolean,
      default: false,
      doc: "Whether the UUID is a low cardinality type: LowCardinality(UUID)"
    ]
  ]
  ...
  AshClickhouse.Type.Helper.graphql_type(__MODULE__, :ch_uuid, :id)
