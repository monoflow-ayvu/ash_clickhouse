defmodule AshClickhouse.Type.ChPolygon do
  @constraints [
    nullable?: [
      type: :boolean,
      default: false,
      doc: "Whether the Polygon can be null: Nullable(Polygon)"
    ],
    low_cardinality?: [
      type: :boolean,
      default: false,
      doc: "Whether the Polygon is a low cardinality type: LowCardinality(Polygon)"
    ]
  ]

  @moduledoc """
  A ClickHouse-specific type for abstracting polygons into a single type.
  ...
  def generator(_constraints) do
    Enum.map(1..3, fn _ -> AshClickhouse.Type.ChRing.generator([]) end)
  end
