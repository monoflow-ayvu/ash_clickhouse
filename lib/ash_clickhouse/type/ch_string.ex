defmodule AshClickhouse.Type.ChString do
  @constraints [
    max_length: [
    ...
    low_cardinality?: [
      type: :boolean,
      doc: "If true, the value is stored as a LowCardinality(String)",
      default: false
    ],
    nullable?: [
      type: :boolean,
      doc:
        "If true, the value is stored as a Nullable(String) or Nullable(LowCardinality(String)) if low_cardinality? is true",
      default: false
    ]
  ]
  ...
  AshClickhouse.Type.Helper.graphql_type(__MODULE__, :ch_string, :string)
