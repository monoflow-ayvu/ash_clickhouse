...
defmodule Mix.Tasks.AshClickhouse.Rollback do
  use Mix.Task
  ...
  def run(args) do
    ...
    rest_opts =
      ...
      |> AshClickhouse.Mix.Helpers.delete_flag("--only-tenants")
      |> AshClickhouse.Mix.Helpers.delete_flag("--except-tenants")
      |> AshClickhouse.Mix.Helpers.delete_arg("-r")
      |> AshClickhouse.Mix.Helpers.delete_arg("--already-started")
