...
# SPDX-FileCopyrightText: 2025 ash_clickhouse contributors <https://github.com/monoflow-ayvu/ash_clickhouse/graphs/contributors>
#
# SPDX-License-Identifier: MIT

defmodule Mix.Tasks.AshClickhouse.Create do
  use Mix.Task
  ...
  def run(args) do
    ...
    repos =
      AshClickhouse.Mix.Helpers.repos!(opts, args)
    ...
    rest_opts = AshClickhouse.Mix.Helpers.delete_arg(args, "--domains")
